...
#define _USE_ADAPTER_DPI_     // 适配DPI开关(方便调试) add by jshuang 2019-8-23
...
#define UISTATE_CAPTURED     0x00000040
	...
	public:
		...
		bool InitControls(CControlUI* pControl, CControlUI* pParent = NULL);  // @yuegy修改于2019/8/2
		...
		//---loki 增加资源模块id
		void SetResourceModuleID( int res );
		int GetResourceModuleID() const;
		//------------end
		//Zero Add
		void CleanToolTips();
		//------------end
        ...
        static void SetAllDPI(HWND hWnd, int iDPI);//修改hWnd的子窗口的dpi.  add by jason 2019-08-04
	...
	private:
		...
		//---loki 增加资源模块id ，id根据fmwnd中的resourcename 与资源中的resName对应，在commonResource中以ID的方式管理
		int	m_resourceModuleID = -1; //大于0，为正常
		//--------end --

        int m_dpi = 96;//记录dpi，by jason
