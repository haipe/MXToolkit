...
namespace DuiLib {
	...
	public:
		...
		CDuiString GetRawText() const;//解决win10获取密码为密文的bug
		...
		void SetKeepShowTip(bool bKeepTip) { m_bKeepShowTip = bKeepTip; };
	...
	protected:
		...
		bool m_bDrawCaret;
		bool m_bInited;
		bool m_bMenu; //Martin By 2018.11.08
        // keepshowtip 保持编辑框中的提示在编辑框获取焦点时不被销毁
		bool m_bKeepShowTip = false;//增加 "keepshowtip" 属性 add by jshuang 2019-8-21
        ...
        int m_iTipFont;    // 增加提示文本字体 "tipfont" add by jshuang 2019-08-22
	};
