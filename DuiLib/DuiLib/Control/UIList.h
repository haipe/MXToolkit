...
#define UILIST_MAX_COLUMNS 32
	...
	typedef struct tagTListInfoUI
	{
		...
		int nFont;
        int nSelectedFont;  // 选中字体属性 "itemselectedfont" add by jshuang 2019-8-21
		UINT uTextStyle;
		RECT rcTextPadding;
		DWORD dwTextColor;
		DWORD dwBkColor;
		...
		bool bRSelected;
        SIZE m_cxyListFixed;  // add by jshuang 2019-09-30 List Item size 
	} TListInfoUI;
	...
	public:
		...
		virtual bool SelectItem(int iIndex, bool bTakeFocus = false, bool bMsg = true) = 0; // 多个notify控制参数 @yuegy
	...
	public:
		...
		void SetSelectedItemFont(int iFont);//设置选中字体 Zero
