...
// UIRichEditEx 新增 fsmeeting justin 2018 ---begin
#define DUI_MSGTYPE_RICH_RMENU             (_T("rich_rmenu"))
#define DUI_MSGTYPE_RICH_RLINK             (_T("rich_rlink"))
#define DUI_MSGTYPE_RICH_LLINK             (_T("rich_llink"))
//-----------------------------------end
...
//begin add by jason 2019-02-14 用于TileLayout布局，方向键选中项
#define DUI_MSGTYPE_ITEMMOVE_UP 		   (_T("itemmoveup"))
#define DUI_MSGTYPE_ITEMMOVE_DOWN 		   (_T("itemmovedown"))
#define DUI_MSGTYPE_ITEMMOVE_LEFT 		   (_T("itemmoveleft"))
#define DUI_MSGTYPE_ITEMMOVE_RIGHT		   (_T("itemmoveright"))
//end add by jason 2019-02-14
...
#define  DUI_CTR_ICON                            (_T("Icon"))//add by jason 2019-02-14
...
#define  DUI_CTR_IMAGEEX						 (_T("ImageEx"))//add by jason 2019-04-02
...
#define  DUI_CTR_TILEELEMENT					 (_T("TileElement"))//add by jason 2019-02-14
