...
namespace DuiLib {
	...
	public:
		...
		//loki增加多语言tooltip控制---------------------
		virtual bool IsResourceTooltip() const;
		virtual const CDuiString& GetResourceTooptip() const;
		virtual void SetResourceTooptip(LPCTSTR pstrName);
		//------------end
		...
		// 鼠标提示 loki 修改返回类型
		virtual const CDuiString& GetToolTip();
        ...
        virtual bool IsManualFloat() const;//loki add 手动调用SetPos  xml manualfloat="true" 属性 默认 false
		virtual void SetManualFloat(bool bManual = false);//loki add 手动调用SetPos  
	...
	protected:
		...
		bool m_bFocused;
		bool m_bFloat;
        bool m_bManualFloat;    //loki add 手动调用SetPos  xml manualfloat="true" 属性 默认 false
        ...
        CDuiString m_sResourceTooltip;//loki增加多语言tooltip控制
		int  m_nLanguageIdentification;//loki 增加多语言标识，表示是否需要更新多语言
		CDuiString m_sText;
