...
typedef jsValue(JS_CALL* jsNativeFunction) (const char* name, jsExecState es); //[haipe]增加名称 2018-12-4 以便回调

typedef jsValue(WKE_CALL_TYPE* wkeJsNativeFunction) (const char* name, jsExecState es, void* param); //[haipe]增加名称 2018-12-4 以便回调
